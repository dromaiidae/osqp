...
* OSQP Versioning *
*******************/
# define OSQP_VERSION ("0.4.1") /* string literals automatically null-terminated
                                   */
...
*************************/
enum linsys_solver_type { QDLDL_SOLVER, MKL_PARDISO_SOLVER, CS294_SOLVER };
static const char *LINSYS_SOLVER_NAME[] = {
  "qdldl", "mkl pardiso", "cs294"
};
